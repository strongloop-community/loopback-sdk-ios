...
Thank you for your interest in `loopback-sdk-ios`, an open source project
administered by StrongLoop.

Contributing to `loopback-sdk-ios` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-sdk-ios)
